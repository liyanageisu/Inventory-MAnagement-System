...
public class Availability extends javax.swing.JFrame {
    ...
    table.setColumnIdentifiers(new Object[]{"Item", "Brand", "Amount"});
    ...
    try {
        ...
        while (rs.next()) {
            String item = rs.getString("iName");
            String brand = rs.getString("iBrand");
            int amount = rs.getInt("amount");
            table.addRow(new Object[]{item, brand, amount});
        }
    } 
    catch(Exception e){ 
